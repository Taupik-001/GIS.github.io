...
function ComponentLevelTwo(){
    ...
    LightSaber24 = new Object(8700, 601, 350, 120, "LightSaberHo.png", "image")
}
...
function Object(x, y, width, height, color, type){
    ...
    this.MovementMeteor2 = function(){
        this.x += this.mX
        this.y += this.mY
        var myMetRight = (1200 - LimitObject) - this.width
        if(this.x > myMetRight){
            this.mX = -5
        }
        var myMetLeft = (this.width - LimitObject) - this.width
        if (this.x < myMetLeft) {
        	this.mX = 5
        }
    }
...
function LevelTwoGame(){
    ...
    LightSaber23.MovementLightSaber1()
    LightSaber23.LigX = -SpeedLevel
    LightSaber24.UpdateObject()
    LightSaber24.MovementLightSaber1()
...
function ComponentLevelThree(){
    ...
    Meteor1 = new Object(1200, 225, 150, 150, "Meteor.png", "image")
